...
public class ImageSelector {
    ...
    public String buildImageSelector(String image) {
        ...
        builder.append("<label class=\"signup font-layout-data-tables bottom-spacing-20\" for=\"file1\" style=\"display: block;\">Upload files (images) &nbsp;</label><img class=\"image-rounded image-shadowing image-rounded-10 top-spacing-20\" src=\"resources/images/"+ image + "\" title=\""
                + ModernDrummerMessages.IMAGE_BROWSE
    ...
    private void buildFileButtonWrapper(final StringBuilder builder) {
      ...
      builder.append("<input class=\"file_browse file\" type=\"file\" size=\"35\" name=\"file1\" id=\"file1\" multiple></input>");
      builder.append("</div>");
    }
    ...
    public String imageSelectButton() {
        ...
        builder.append("<input id=\"radioAddProfileImageGroup\" type=\"radio\" name=\"radioAddProfileImage\" value=\"radioAddProfileImage_1\">");
    ...
    public String buildImageSelectorWithRow() {
        ...
        builderContent.append("<input class=\"file_browse file\" type=\"file\" size=\"35\" name=\"file1\" id=\"file1\" multiple></input></div>");
