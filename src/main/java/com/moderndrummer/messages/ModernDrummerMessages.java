...
public class ModernDrummerMessages {
    ...
    public final static String DIVER_INSERT = "Diver inserted";
    public final static String DIVER_DELETE = "Diver deleted";
    public final static String DIVER_UPDATE = "Diver updated";
    public final static String USER_NO_DIVER = "User is not a diver";
    public final static String DIVER_LOG_DELETED = "Divelogs deleted";
    public final static String DIVER_LOCATION_NOT_UPDATED = "Divelocation not able to update, or already exists";
    ...
    public final static String DIVER_LOG_UPDATE = "Divelog updated";
    public final static String ERROROUS_TRANSACTION = "Something went wrong";
    public final static String DIVER_LOG_INSERT = "Divelog inserted";
    public final static String DIVER_INFO_MISSING = "Diver info missing";
    public final static String DIVER_LOG_PDF = "Divelog printed to PDF format";
    public final static String DIVER_LOG_PDF_EMPTY = "No divelogs, therefor no pdf file will be outprinted";
    public final static String PDF_DIR_LOCATION = " and PDF can be found in dir";
    public final static String DIVER_LOG_BY_DIVER = "Divelogs by Diver";
    public final static String DIVER_LOG_SEARCH = "Divelog search";
    public final static String DIVER_LOG_NOT_CHOSEN = "Please choose divelog!";
    public final static String DIVER_LOG_SITE_DELETE = "Dive logs exists remove them first";
    ...
    public final static String DIVER_NOT_CHOSEN = "Please choose diver";
    public final static String DIVER_NOT_INSERT = "Diver not inserted";
    public final static String DIVER_MISSING = "Diver missing";
    public final static String DIVER_EXISTS = "Diver already exists";
    public final static String DIVER_EMAIL_EXISTS = "Email already exists";
    public final static String DIVER_WRONG_PHONENR = "Invalid phone nr";
    ...
    public final static String DIVER_CERTIFICATE_DELETE = "Diver Certificate deleted";
    public final static String DIVER_CERTIFICATE_DELETE_ERROR = "Check Diver certificate, or Certificate and Diver first before deletion";
    public final static String DIVER_CERTIFICATE_DELETE_ERROR_2 = "Something went wrong during delete";
    public final static String DIVER_CERTIFICATE_UPDATE_ERROR = "Check Certificate and Diver first before update";
    ...
    public final static String DIVE_LOG_NO_VERIFICATION = "Divelog must be verified by any other authorized diver!";
    ...
    public final static String DIVER_CERTIFICATES = "Diver certificates";
    public final static String DIVER_CERTIFICATES_ALL = "All Diver Certificates";
    public final static String DIVER_CERTIFICATES_EMPTY = "No diver certificates";
    public final static String DIVER_CERTIFICATE_INSERT = "Check Certificate and Diver first before insert";
    ...
    public final static String DIVE_RECORDS_DIVER = "Dive Records by Diver  ";
    public final static String DIVE_RECORDS_SCHOOL = "Dive Records by Diver School ";
    ...
    public final static String DIVE_INSTRUCTORS_SEARCH_SCHOOL = "Dive instuctors by diver school ";
    public final static String DIVE_INSTRUCTORS_SCHOOL_INVALID = "Dive instuctor or diver school is invalid";
    ...
    public final static String DIVE_INSTRUCTORS_DIVER_INSERT = "Dive instructor inserted with dive schools";
    public final static String DIVE_INSTRUCTOR_UPDATE = "Dive instructor updated";
    public final static String DIVER_UPGRADED_TO_INSTRUCTOR = "Diver upgraded to instructor";
    public final static String DIVE_INSTRUCTORS_DIVER_UPDATE = "Dive instructor updated";
    public final static String DIVE_INSTRUCTORS_INSERT_DIVER_UPDATE = "Dive instructor inserted diver updated";
    public final static String DIVE_INSTRUCTORS_INSERT_DIVER_DELETE = "Dive instructor and in school deleted";
    ...
    public final static String DIVE_INSTRUCTORS_IN_SCHOOL = "Dive instructor already assigned to a diverschool";
    public final static String VERIFICATOR_NOT_FOUND = "Verificator: Dive instructor or diver not found";
    public final static String USER_CATEGORY_MISSING = "Please choose user category";
    public final static String DIVER_SCHOOL_NOT_EXISTS = "Diver school not found";
    public final static String NOT_FOUND = "Not found";
    public final static String EMAIL_NO_EXISTS = "Email not found in Divemasters";
    public final static String DIVER_SCHOOL_NOT_CHOSEN = "Diver school not chosen";
    public final static String DIVER_SCHOOLS_DELETED = "Diver schools deleted";
    public final static String DIVER_SCHOOL_NO_TO_DELETE = "No diver schools to delete";
    public final static String USER_UPDATED = "User updated";
    public final static String DIVE_INSTRUCTORS_NO_DIVER = "Dive instructor must be a diver";
    ...
    public final static String DIVERSCHOOL_NOT_AVAILABLE = "Diverschool not found or chosen, send an email to admin to add your school. Diverschool must be available to signup as Instructor.";
    public final static String BASIC_PAGE_SECTION_TEXT = "Keep track of your dive logs, administer your certificates, dive sites and diver schools, sign up free today!"
    ...
    public final static String SIGNUP_DIVEMASTER_TEMPORARY = "You have have signed up for the DiveMaster Application with a simple Signup, which means a temporary username and password was created. You need to update the other diver data.";
    ...
    public final static String DIVE_INSTRUCTOR_SCHOOL =  "Diveinstructor at diverschool:";
