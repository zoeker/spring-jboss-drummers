...
public class FileUtils {
    ...
    public static String getExtension(final String fileName)
        ...
        if (StringUtilValidator.isEmptyOrNull(fileName)) {
            throw new ModernDrummerInvalidFormatException(
                    ModernDrummerMessages.FILE_ERROR);
        }
        ...
        if (index == -1) {
            ...
            return trimmedFileName.substring(index + 1,
    ...
    public static boolean isValidFileName(final String fileName) {
        ...
        if (StringUtilValidator.isEmptyOrNull(FilenameUtils
    ...
    public static boolean isValidYouTubeUrl(final String url) {
        ...
        if (!org.apache.commons.lang3.StringUtils.startsWith(url,
                WebComponentsParameters.YOU_TUBE_URL)
                && !org.apache.commons.lang3.StringUtils.startsWith(url,
                        WebComponentsParameters.YOU_TUBE_URL_EMBED)) {
            return false;
        }
    ...
    public static String renameFileName(final String name, final int counter)
        ...
        final String newFileName = name.substring(0, indexExtension) + "_"
                + String.valueOf(counter) + "." + extension;
