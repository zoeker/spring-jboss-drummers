...
public class IntegerConverter {
     ...
     */
    public static Integer checkInteger(final String value)
    ...
    public static Integer emptyValueReturnZero(final String value)
            throws EntityParseException {
        if (value == null || value.length() == 0) {
            return 0;
        } else if (Pattern.matches("[a-zA-Z]+", value)) {
            throw new EntityParseException(value + " "
                    + ModernDrummerException.NO_NUMBER_VALUE);
    ...
    public static Integer findIntegerValue(final String value) {
        ...
        if (value == null || value.length() == 0) {
            ...
            Integer counter = 1;
            while (matcher2.find()) {
                counter = Integer.valueOf(value.substring(matcher2.start(),
                        matcher2.end()));
            }
     ...
     *         DiveMasterParseException * @throws DiveMasterParseException
     */
    public static Integer validateInteger(final String value)
            throws EntityParseException {
        if (value == null || value.length() == 0) {
            throw new EntityParseException(
                    ModernDrummerException.EMPTY_NUMBER_VALUE);
        } else if (value.length() > 0 && value.matches("[0-9]+")) {
            return Integer.valueOf(value);
        } else {
            throw new EntityParseException(ModernDrummerException.NO_NUMBER_VALUE);
     ...
     */
    public static Integer validateInteger(final String value, final String field)
            throws EntityParseException {
        if (value == null || value.length() == 0) {
     ...
     */
    public static Integer validateIntegerCountry(final String value)
            throws EntityParseException {
        if (value == null || value.length() == 0) {
            throw new EntityParseException(
                    ModernDrummerException.EMPTY_NUMBER_VALUE + " Choose country");
        } else if (Pattern.matches("[a-zA-Z]+", value)) {
            throw new EntityParseException(value + " "
                    + ModernDrummerException.NO_NUMBER_VALUE + " Choose country");

        } else if (value.length() > 0) {
            final boolean matches = Pattern.matches("[0]{1}", value);
            if (matches) {
                throw new EntityParseException(value + " "
                        + ModernDrummerException.ZERO_NUMBER_VALUE
                        + " Choose country");
            } else {
                return Integer.valueOf(value);
            }
            ...
            throw new EntityParseException(
                    ModernDrummerException.ZERO_NUMBER_VALUE + " Choose country");
        }
    }
     ...
     * @return Integer * @throws DiveMasterParseException
     */
    public static Integer validateIntegerUpdate(final String value)
            throws EntityParseException {
        if (value == null || value.length() == 0) {
            return 0;
        } else if (value.length() > 0 && value.matches("[0-9]+")) {
     ...
     *         DiveMasterParseException * @throws DiveMasterParseException
     */
    public static Integer validateIntegerZero(final String value)
            throws EntityParseException {
        if (value == null || value.length() == 0) {
            throw new EntityParseException(
                    ModernDrummerException.EMPTY_NUMBER_VALUE);
    ...
    public static Integer validateIntegerZero(final String value,
        ...
        if (value == null || value.length() == 0) {
            ...
            throw new EntityParseException(field + " " + value + " "
                    + ModernDrummerException.NO_NUMBER_VALUE);
