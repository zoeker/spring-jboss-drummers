...
public abstract class BaseJPQLDao<E> {
  ...
  /*
  protected List setParametersAndReturnResult(final Map<String, Object> criteriaValues,
      final Query q) {

    if (criteriaValues.containsKey(AttributeWebConstants.DIVER_SCHOOL)) {
      q.setParameter("diveSchool", criteriaValues.get(AttributeWebConstants.DIVER_SCHOOL));
    }
    if (criteriaValues.containsKey(AttributeWebConstants.FROM_DATE)) {
      q.setParameter(AttributeWebConstants.FROM_DATE,
          (Date) criteriaValues.get(AttributeWebConstants.FROM_DATE), TemporalType.DATE);
      q.setParameter(AttributeWebConstants.TO_DATE,
          (Date) criteriaValues.get(AttributeWebConstants.TO_DATE), TemporalType.DATE);
    }
    if (criteriaValues.containsKey(AttributeWebConstants.DIVE_NUMBER)) {
      q.setParameter("diveNumber", criteriaValues.get(AttributeWebConstants.DIVE_NUMBER));
    }
    if (criteriaValues.containsKey(AttributeWebConstants.DIVE_LOCATION)) {
      q.setParameter("diveLocation", criteriaValues.get(AttributeWebConstants.DIVE_LOCATION));
    }
    if (criteriaValues.containsKey(AttributeWebConstants.DIVE_SITE)) {
      q.setParameter("diveSite", criteriaValues.get(AttributeWebConstants.DIVE_SITE));
    }
    if (criteriaValues.containsKey(AttributeWebConstants.COUNTRY)) {
      q.setParameter("countryId", criteriaValues.get(AttributeWebConstants.COUNTRY));
    }

    if (criteriaValues.containsKey(AttributeWebConstants.DIVER)) {
      q.setParameter("diverId", criteriaValues.get(AttributeWebConstants.DIVER));
...
*/
/*
  protected List setParametersByEntityTypes(final Map<String, Object> criterias, Query q) {
    if (criterias.containsKey(EntityTypes.DIVER.getNameToMap())) {
      q.setParameter("diverId",
          Integer.valueOf((Integer) criterias.get(EntityTypes.DIVER.getNameToMap())));
    }
    if (criterias.containsKey(EntityTypes.DIVERSCHOOL.getNameToMap())) {
      q.setParameter("diverSchoolId", criterias.get(EntityTypes.DIVER.getNameToMap()));
    }
    if (criterias.containsKey(EntityTypes.DIVESITE.getNameToMap())) {
      q.setParameter("diveSiteId", criterias.get(EntityTypes.DIVESITE.getNameToMap()));
    }
    if (criterias.containsKey(EntityTypes.DIVELOCATION.getNameToMap())) {
      q.setParameter("diveLocationId", criterias.get(EntityTypes.DIVELOCATION.getNameToMap()));
    }
    if (criterias.containsKey(EntityTypes.COUNTRY.getNameToMap())) {
      q.setParameter("countryId", criterias.get(EntityTypes.COUNTRY.getNameToMap()));
    }
  ...
  */
  ...
  protected void verifyByException(final Exception e, String entry, String message)
      throws ModernDrummerJPAException {
  ...
  protected void rollBackTransaction(final Exception e) throws ModernDrummerJPAException{
    try {
      ...
      throw new ModernDrummerJPAException(ModernDrummerMessages.TRANSACTION_ROLLBACK + " "
          + e.getMessage());
  ...
  protected Object doRollBack(Object object, boolean activatedTransaction)
      throws ModernDrummerJPAException {
    try {
  ...
  // testme
  protected void delete(Set<Object> objects, Class clazz)
      throws ModernDrummerJPAException {
  ...
  // testme
  protected E update(final Object object, boolean activatedTransaction, Class clazz)
  ...
  public <T> T instanceOf(Class clazz, Object value) {
    ...
    try {
      ...
      return (T) ct.newInstance(value);
        ...
        | IllegalAccessException | IllegalArgumentException | InvocationTargetException ei) {
  ...
  protected void handleTransactionExceptions(final Exception e, String message)
      throws ModernDrummerJPAException {
  ...
  protected E executeNamedQueryOneParamReturnObject(final Object param1, String namedQuery,
      Class clazz) throws NoResultException, NonUniqueResultException {
    final Query q = em.createNamedQuery(namedQuery, clazz);
    q.setParameter(1, param1);
    final E result = (E) q.getSingleResult();
    return result;
  ...
  protected E executeNamedQueryByIdReturnObject(final int id, String namedQuery)
      throws NoResultException {
    try {
      final Query q = em.createNamedQuery(namedQuery);
      q.setParameter("id", id);
  ...
  protected E executeNamedQueryByTwoParams(final Object param1, final Object param2,
      String namedQuery) throws NoResultException {
    final Query q = em.createNamedQuery(namedQuery);
    q.setParameter(1, param1);
  ...
  protected E executeNamedQueryByThreeParams(final Object param1, final Object param2,
      final Object param3, String namedQuery) {
    final Query q = em.createNamedQuery(namedQuery);
    q.setParameter(1, param1);
    q.setParameter(2, param2);
  ...
  protected List<E> executeNamedQueryByOneParamReturnList(final Object param1, String namedQuery,
      Class clazz) throws NoResultException {
    final Query q = em.createNamedQuery(namedQuery, clazz);
    q.setParameter(1, param1);
  ...
  protected List<E> executeNamedQueryByTwoParamsReturnList(final Object param1,
      final Object param2, String namedQuery, Class clazz) throws NoResultException {
    final Query q = em.createNamedQuery(namedQuery, clazz);
    q.setParameter(1, param1);
    q.setParameter(2, param2);
    final List<E> result = q.getResultList();
  ...
  protected E executeNamedQueryByOneParam(final Object param1, String namedQuery)
      throws NoResultException {
    try {
      final Query q = em.createNamedQuery(namedQuery);
      q.setParameter(1, param1);
  ...
  protected List<E> executeNamedQueryReturnList(String namedQuery, Class clazz)
      throws NoResultException {
    try {
  ...
  protected Integer getNamedQueryResultValue(E e, String namedQuery, Class clazz)
      throws ModernDrummerJPAException {
    LOGGER.info("id : " + e);
    final Query q = em.createNamedQuery(namedQuery, clazz);
