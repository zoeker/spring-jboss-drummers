     ...
     change : function(event) { 
     	...
     	for(i=0; i<this.files.length; i++){
			...
			reader.onload = function (e) {
				...
				//$('.profile_image').attr({'src': e.target.result, 'alt': 'Image preview' }).addClass(settings['prefix']+'thumb').appendTo($('#'+settings['prefix']+id));
				//$('.profile_image').attr('height','100');
				//$('.profile_image').attr('width','150');
